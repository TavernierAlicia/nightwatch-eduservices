...
module.exports = {
  ...
  //     //   });
  //     // };
  //     .switchWindow("https://account.activedirectory.windowsazure.com/ChangePassword.aspx?BrandContextID=O365&ruO365=")

  //     .pause(5000)
  //     // .assert.elementPresent('.ChangePasswordControl$OldPasswordTextBox')
  //     .assert.elementPresent('.shell-page-title')


  //     .setValue('.ChangePasswordControl$OldPasswordTextBox', pwd)
  //     .setValue('.ChangePasswordControl$NewPasswordTextBox', pwd)
  //     .setValue('.ChangePasswordControl$ConfirmNewPasswordTextBox', pwd)
  //     .click('a[id="ChangePasswordControl_OkButton"] > span')

  //     // input name="ChangePasswordControl$OldPasswordTextBox"
  //     // name="ChangePasswordControl$NewPasswordTextBox"
  //     // name="ChangePasswordControl$ConfirmNewPasswordTextBox"
  //     // a id="ChangePasswordControl_OkButton" span
  //     .end()
  // },
}
